...
public class CandidateUploadController {
        ...
        // public ResponseEntity<ApiDataResponse<List<ResumeResponseDto>>>
        // getResumesByCandidate(
        // @PathVariable("candidateId") Long candidateId) {
        // List<ResumeResponseDto> results =
        // resumeService.getResumesByCandidateId(candidateId);
         ...
         */
        // @PostMapping(value = "/{candidateId}/resume", consumes =
        // MediaType.MULTIPART_FORM_DATA_VALUE)
        // public ResponseEntity<ApiDataResponse<ResumeResponseDto>> uploadResume(
        // @PathVariable("candidateId") Long candidateId,
        // @RequestParam("file") MultipartFile file,
        // @RequestParam(value = "status", defaultValue = "true") boolean status) {
        // ResumeResponseDto result = resumeService.createResume(candidateId, file,
        // status);
        ...
        // public ResponseEntity<ApiDataResponse<Map<String, String>>> getAvatarUrl(
        // @PathVariable("candidateId") Long candidateId) {
         ...
         */
        // @PostMapping(value = "/{candidateId}/avatar", consumes =
        // MediaType.MULTIPART_FORM_DATA_VALUE)
        // public ResponseEntity<ApiDataResponse<Map<String, String>>> uploadAvatar(
        // @PathVariable("candidateId") Long candidateId,
        // @RequestParam("file") MultipartFile file) {
        // // !! LƯU Ý BẢO MẬT:
        // // Bạn nên thêm logic ở đây để kiểm tra xem người dùng đã được xác thực
        // // (authenticated)
        ...
        // deleteAvatar(@PathVariable("candidateId") Long candidateId) {
        ...
        // getAllImageUrls(
        // @PathVariable("candidateId") Long candidateId) {
        // List<UploadDataResponse> urls =
        // candidateUploadService.getAllImageUrl(candidateId);
         ...
         */
        // @PostMapping(path = "/{candidateId}/gallery", consumes =
        // MediaType.MULTIPART_FORM_DATA_VALUE)
        ...
        // public ResponseEntity<ApiDataResponse> deleteImage(@PathVariable("imageId")
        // Long imageId) {
        // // !! LƯU Ý BẢO MẬT: (Tương tự như trên)
